...
import sys
sys.path.append('/home/eriksen/code/bcnz/bcnz/lib')
sys.path.append('/nfs/pic.es/user/e/eriksen/code/bcnz/bcnz/lib')
sys.path.append(os.path.expanduser('~/Dropbox/pauphotoz/bcnz/bcnz/lib'))
import libpzqual
